...
if __name__ == "__main__":
    entityPaser = EntityPropertyParser(
        property_extended_label_filepath='../../setup_data/wk_data_names_props_of_interest.json', model_type='trf')
    ...
    prop_label_dict = json.load(open('../../setup_data/wk_data_names_props_of_interest.json', 'r'))
